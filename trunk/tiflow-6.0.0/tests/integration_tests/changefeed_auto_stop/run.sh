...
function run() {
	...
	export GO_FAILPOINTS='sdbflow/cdc/processor/pipeline/ProcessorSyncResolvedError=1*return(true);sdbflow/cdc/processor/ProcessorUpdatePositionDelaying=sleep(1000)'
