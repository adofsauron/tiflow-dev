...
func interestingGoroutines() (gs []string) {
	...
	ignoreList := []string{
		...
		"sdbflow/cdc/sorter/unified.newBackEndPool",
		"sdbflow/cdc/sorter/unified.(*heapSorter).flush",
		// kv client region worker pool
		"sdbflow/cdc/kv.RunWorkerPool",
		"sdbflow/pkg/workerpool.(*defaultPoolImpl).Run",
		// library used by log
