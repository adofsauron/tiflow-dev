...
function run() {
	...
	export GO_FAILPOINTS='sdbflow/cdc/sinkv2/eventsink/txn/mysql/MySQLSinkExecDMLError=return(true);sdbflow/cdc/sinkv2/eventsink/mq/dmlproducer/KafkaSinkAsyncSendError=return(true)'
